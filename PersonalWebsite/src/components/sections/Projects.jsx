      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.slice(0, visibleProjects).map((project, index) => (
          <div
            ...
            className={`group relative bg-gray-800 rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 cursor-pointer ${animatingProjects.has(index) ? 'animate-fade-in-up' : ''
              }`}
